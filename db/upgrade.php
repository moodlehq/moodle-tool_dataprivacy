...
function xmldb_tool_dataprivacy_upgrade($oldversion) {
    ...
    if ($oldversion < 2018031900) {
        ...
        // Savepoint reached.
        upgrade_plugin_savepoint(true, 2018031900, 'tool', 'dataprivacy');
    }

    if ($oldversion < 2018031904) {
        ...
        upgrade_plugin_savepoint(true, 2018031904, 'tool', 'dataprivacy');
    }

    if ($oldversion < 2018031905) {
