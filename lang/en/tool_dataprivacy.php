...
$string['applyallinstances'] = 'Apply to all instances';
$string['applyallinstanceslabel'] = 'Checking "Apply to all instances" will cascade the current category and purpose settings to all context instances down the Data Registry tree.';
...
$string['contextlevelname30'] = 'User context';
$string['contextlevelname40'] = 'Course category context';
$string['contextlevelname50'] = 'Course context';
$string['contextlevelname70'] = 'Activity module context';
$string['contextlevelname80'] = 'Block context';
